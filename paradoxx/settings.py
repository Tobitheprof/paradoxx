"""
Django settings for paradoxx project.
...
SECRET_KEY = 'django-insecure-x=opj!)jb7bt*jfg$k2-h50*(9@h_n4i+#saegx&5sato=w%rc'
...
WSGI_APPLICATION = 'paradoxx.wsgi.application'
